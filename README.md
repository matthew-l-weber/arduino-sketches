...
## Notes on monitoring a vibrating machine and generating alert notifications


Email sending library :  
https://create.arduino.cc/projecthub/xreef/send-email-with-esp8266-and-arduino-dfa5de
https://medium.com/@d.luffy.gomu.1234/five-ways-to-send-email-from-arduino-36fb187b2ebf

FFT stuff 
https://github.com/kosme/arduinoFFT
https://forum.arduino.cc/index.php?topic=634495.0
http://www.arduinoos.com/2010/10/fast-fourier-transform-fft/

```

(Below based on easyfft arduino)
